...
infile<-"cad.add.160614_manhformatv3.txt"
configfile<-"config.txt"
snpfile<-"56cad.add.160614.variants.txt"

manhplot(infile = infile,outfile = "X:\\cgrace\\test1234", configfile = configfile, snpfile = snpfile)
