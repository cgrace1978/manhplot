...
test_that("Run the manhplusplot function with default params", {
  ...
  manhplusplot(infile = infile, outfile = "testpdf",configfile = configfile, snpfile = snpfile)
})
...
test_that("Run the manhplusplot function with output as tiff file", {
  ...
  manhplusplot(infile = infile, outfile = "testtiff",configfile = configfile, snpfile = snpfile, drawastiff = T)
})
